...
@save "data/Germany_final.jld" Prognosis Data
...
MonthPrognosisPlot=scatter(uₓ[DataTime],label=["Confirmed","Deaths"],
            title="One Month Prognosis Germany",legend=:left,color=[:orange :black])
...
savefig(MonthPrognosisPlot,"figs/Germany_MonthPrognosis.pdf")


writetimearray(Prognosis[MonthTime], "data/Germany_MonthPrognosis.csv")
writetimearray(Parameter[MonthTime], "data/Germany_MonthParameter.csv")
writetimearray(Prognosis[WeekTime], "data/Germany_WeekPrognosis.csv")
writetimearray(Parameter[WeekTime], "data/Germany_WeekParameter.csv")
